...
cl /nologo /W3 /O2 /Oi /Gy /GL /GS- /GR- /MT /std:c++20 /permissive- /Zc:inline /Zc:forScope /Zc:wchar_t /fp:precise /D NDEBUG /D _CONSOLE /D UNICODE /D _UNICODE /D _CRT_SECURE_NO_WARNINGS /D _HAS_EXCEPTIONS=0 mini-ai.cpp resource.res /Fe:mini-ai.exe /link /nologo /LTCG /OPT:REF /OPT:ICF /SUBSYSTEM:WINDOWS /MANIFEST:EMBED user32.lib gdi32.lib shell32.lib ole32.lib comdlg32.lib
